...
### Version 1 (Result: Correctness score: 5 / 5 (compiles and correct), runtime in ms: 0.417):
```OCL
...
### Version 2 (Result: Correctness score: 5 / 5 (compiles and correct), runtime in ms: 0.650):
```OCL
