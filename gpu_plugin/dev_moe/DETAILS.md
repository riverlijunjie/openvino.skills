...
## Weights quantization support for MoE

### Weight quantization
- Support for Asymmetric quantization in MoE models: weight - u4/u8, scale - f16, zero_point - u/u8
- Support for Symmetric quantization in MoE models: weight - i4/i8, scale - f16, no zero_point
- Support for per-channel quantization in MoE models
- Support for group-wise quantization in MoE models, group size is 128/256
