...
> Iterations 28 = v1..v20 (20 canonical versions) + v21..v29 excluding v27b (8 new versions).  
...
## Failed / Dead-End Experiments (Post-v28)

| # | Experiment | Strategy | Roofline % | Why Failed |
|---|------------|----------|------------|------------|
| 29 | v29 | SLM cooperative B load (sg_row=0 fetches, others read from SLM) | 40–43% | 2× `barrier(CLK_LOCAL_MEM_FENCE)` per iter at 512 threads/WG = –23 pp overhead |
| — | probe | `intel_sub_group_2d_block_read_16b_32r16x4c` (4-column wide A read) | N/A | Builtin not defined on B580; only `*1c` and `*2c` exist for 32-row shape |
