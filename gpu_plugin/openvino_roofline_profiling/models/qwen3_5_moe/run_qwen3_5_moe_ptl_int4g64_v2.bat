...
REM ================================================================
REM  Qwen3.5-MoE  INT4 g=64 all-compressed  —  FULL RE-RUN v2
...
set LOGS=D:\river\moe\roofline_results\qwen3_5_moe_int4g64\ptl_v2
...
echo === INT4g64 FULL RE-RUN v2 START %date% %time% > "%LOGS%\_run.log"
...
echo All INT4 g=64 v2 full benchmarks complete.
