...
REM ================================================================
REM  Qwen3.5-MoE  INT4 g=64 all-compressed  —  FULL RE-RUN v4
REM  Shared expert FUSED into MoE kernel (shared_I=512, shared_quant=u4)
REM  OV build includes FuseMOESharedExpert fix (commit 2abcdce7f3)
REM ================================================================
REM Config:
REM   Body FC (QKV, O, linattn projs): INT4 asymmetric g=64
REM   MoE fused (routed+shared): INT4 g=64 (SI=512, shared_quant=u4)
...
set LOGS=D:\river\moe\roofline_results\qwen3_5_moe_int4g64\ptl_v4
...
echo === INT4g64 FULL RE-RUN v4 START %date% %time% > "%LOGS%\_run.log"
...
REM --- MoE fused (routed+shared), INT4 g=64 ---
"%CLI%" -d "%BUILD%\moe_bench.exe" 1 1 2048 512 256 8 64 100 10 4 64 512 u4 > "%LOGS%\moe_fused_decode_M1.log" 2>&1
...
"%CLI%" -d "%BUILD%\moe_bench.exe" 1 1024 2048 512 256 8 64 20 5 2 64 512 u4 > "%LOGS%\moe_fused_prefill_S1024.log" 2>&1
...
"%CLI%" -d "%BUILD%\moe_bench.exe" 1 2048 2048 512 256 8 64 15 3 2 64 512 u4 > "%LOGS%\moe_fused_prefill_S2048.log" 2>&1
...
"%CLI%" -d "%BUILD%\moe_bench.exe" 1 4096 2048 512 256 8 64 10 2 2 64 512 u4 > "%LOGS%\moe_fused_prefill_S4096.log" 2>&1
...
"%CLI%" -d "%BUILD%\moe_bench.exe" 1 8192 2048 512 256 8 64 8 2 2 64 512 u4 > "%LOGS%\moe_fused_prefill_S8192.log" 2>&1
...
"%CLI%" -d "%BUILD%\moe_bench.exe" 1 16384 2048 512 256 8 64 4 1 1 64 512 u4 > "%LOGS%\moe_fused_prefill_S16384.log" 2>&1
...
"%CLI%" -d "%BUILD%\moe_bench.exe" 1 32768 2048 512 256 8 64 2 1 1 64 512 u4 > "%LOGS%\moe_fused_prefill_S32768.log" 2>&1
...
"%CLI%" -d "%BUILD%\moe_bench.exe" 1 65536 2048 512 256 8 64 2 1 1 64 512 u4 > "%LOGS%\moe_fused_prefill_S65536.log" 2>&1
...
"%CLI%" -d "%BUILD%\moe_bench.exe" 1 131072 2048 512 256 8 64 1 1 1 64 512 u4 > "%LOGS%\moe_fused_prefill_S131072.log" 2>&1
...
echo All INT4 g=64 v4 full benchmarks complete.
