...
REM window; FC/MoE/GDN/small ops are M=1 constant. We therefore sweep PA decode at
REM KV = P (window start), P+256 (window average), P+512 (window end).
REM ============================================================================
...
REM ---------- fc_bench: full-attn QKV+gate (9216), O, LM_Head ----------
call :do fc_qkv_decode_M1             "%BUILD%\fc_bench.exe" 1    2048   9216 128 5000 200 8 u4 64
...
for %%S in (1024 2048 4096 8192) do (
  call :do fc_qkv_prefill_S%%S        "%BUILD%\fc_bench.exe" %%S 2048 9216 128 30 5 8 u4 64
